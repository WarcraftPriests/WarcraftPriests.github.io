...
var TooltipBuilder = (function() {
   ...
   */
  function createWowheadLink(text, url, itemId, ilvl) {
   ...
   * @returns {HTMLAnchorElement}
   */
  function createTalentLink(talentName) {
    var link = document.createElement('a');
   ...
   */
  function buildTooltipLine(content) {
   ...
   * @returns {string} HTML string
   */
  function buildWowheadLinkLine(displayName, itemId, url, ilvl) {
   ...
   * @returns {string} HTML string
   */
  function buildTalentLinkLine(talentName) {
   ...
   * @returns {string} HTML string
   */
  function buildMultiLinkLine(items) {
    var elements = [];
  ...
  return {
    ...
    createWowheadLink: createWowheadLink,
    createTalentLink: createTalentLink,
    createTextNode: createTextNode,
    createSpacer: createSpacer,
    buildTooltipLine: buildTooltipLine,
    buildWowheadLinkLine: buildWowheadLinkLine,
    buildTalentLinkLine: buildTalentLinkLine,
    buildTextLine: buildTextLine,
    buildMultiLinkLine: buildMultiLinkLine
  };
})();
